...
#: ADMIN
    ...
    # The home brand url in the menu
    ADMIN_BRAND_URL = "/admin/"

    # The min ACL. By default it's `ADMIN`
    # MODERATOR | CONTRIBUTOR | MANAGER | ADMIN | SUPERADMIN
    ADMIN_MIN_ACL = "MODERATOR"
